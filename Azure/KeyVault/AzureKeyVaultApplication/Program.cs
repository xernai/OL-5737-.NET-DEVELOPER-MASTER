using AzureKeyVaultApplication.Models;
...
builder.Services.AddAzureClients(azureClientFactoryBuilder =>
{
    ...
    {
        throw new InvalidOperationException("KeyVault:VaultUri is not configured. Set it in appsettings.json or environment variables.");
    }
